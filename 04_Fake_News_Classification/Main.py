...
# Initialize a CountVectorizer object: count_vectorizer Ensure you specify the keyword argument stop_words="english" so that stop words are removed.
...
print(count_df.iloc[:,10000:10020].head())

# Print the head of tfidf_df
print(tfidf_df.iloc[:,10000:10020].head())
...
"""
SECTION 5: NAIVE BAYES CLASSIFIER on TFIDF DATA
"""
...
"""
SECTION 7: INSPECTING THE MODEL
"""
# The coef_ attribute of MultinomialNB is a re-parameterization of the naive Bayes model as a linear classifier model
# For binary classification this is the log of the estimated probability of a feature given the positive class (REAL). 
# The higher the value the more important that feature for the positive class  (REAL).
